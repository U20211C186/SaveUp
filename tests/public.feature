Característica: El usuario quiere publicar un producto
	...
	Escenario: El usuario registrado publica un nuevo producto
		...
		Cuando le de click al boton "Agregar producto"
		Entonces le dirigira a una seccion donde podra ingresar los datos necesarios para el registro de un nuevo producto.
